...
public class PolyService {
	...
	public void ex1() {
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		//car2.setBatteryCapacity(100000000); is undefined for the type Car
...
//	public void method(Car c) {  <- new Tesla  or car c = new Tesla
//		
...
//	}
	...
	public void ex5() {
		...
		for(int i = 0; i < arr.length; i++) {
			...
			// 실행 후 : 각 객체의 오버라이딩 된 toString()이 호출 됨 - 동적 바인딩
